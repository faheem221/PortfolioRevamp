      ...
      <div className="w-full flex justify-center absolute  items-center flex-col    bg-[#FFACAC] rounded-t-2xl">
        <div className="w-full max-w-[1200px] px-5 flex justify-between iphone:flex-col ipad-tablet:flex-row mt-5">
          <div className="iphone:text-center ipad-tablet:text-left">
            ...
            <div className="">
              <p className="font-Outfit font-bold   dark:text-slate-800 iphone:items-center iphone:w-full ipad-tablet:w-full text-slate-50 iphone:text-[2em] iphone:mt-2 desktop:text-[3em] desktop:max-w-[500px]">
                I would love to hear from you
              </p>
              <p className="font-Rubik mt-2 text-slate-50 dark:text-slate-800 iphone:text-[1.1em] desktop:text-[1.1em]">
                If you liked my work. Feel free to reach me.
              </p>
            </div>

            <div className="">
              <p className="text-slate-50 dark:text-slate-800 font-Rubik iphone:text-[1.1em] desktop:text-[1.1em] mt-3 ">
                Don't like the forms? Drop me a line via Email
              </p>
              <a
                className="text-slate-50 dark:text-slate-800 font-[500] font-Rubik iphone:text-[1.2em] desktop:text-[1.2em]"
          ...
          <div className="iphone:text-center ipad-tablet:text-left">
            ...
            <p className="font-Outfit font-[700] text-slate-50 dark:text-slate-800 iphone:text-[2em] desktop:text-[3em] iphone:mt-2">
              Contact Me
            </p>

            <p className="font-Outfit font-[500] mt-5 text-slate-50 dark:text-slate-800">
              Email:{" "}
              <a
                href="mailto:faheemk793@gmail.com"
            ...
            <p className="font-Outfit font-[500] mt-1 text-slate-50 dark:text-slate-800">
              Phone:{" "}
              <span className="font-Rubik font-[400]">+91 85880 47098</span>
            </p>
            <p className="font-Outfit font-[500] mt-1 text-slate-50 dark:text-slate-800 ipad-tablet:max-w-[70%]">
              Address:{" "}
