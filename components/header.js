...
const head = forwardRef((props, ref)=>{
    ...
    const openPdfInNewTab = () => {
      const pdfUrl = "./Faheem_ResumeN.pdf";
            ...
            <div className="flex items-center gap-5 heroBox">
              ...
              >
                {ham ? (
                  ...
                  <p className="  font-Rubik    cursor-pointer iphone:text-[1em] ipad-tablet:text-[1.2em]">
                    menu
                  </p>
                )}
              </motion.div>
            ...
            <AnimatePresence mode="wait">
              {ham ? (
                <motion.div
                  ...
                  className="absolute flex flex-col iphone:w-[104.5%] android:w-[103.5%] iphone:h-[97vh] ipad-tablet:w-[450px] ipad-tablet:h-[80vh]  max-h-[750px]   bg-red-500 top-[.5em] iphone:right-[-.5em] ipad-tablet:right-[-.55%] desktop:right-[-.4%] rounded-3xl z-[-2] overflow-hidden"
                >
                  <motion.div
                    variants={textAnime}
                    initial="initial"
                    animate="animate"
                    className="flex flex-col w-full justify-center  iphone:items-center ipad-tablet:items-start overflow-hidden h-full gap-2 px-5 heroBox"
                  >
                    {navLinks.map((items) => {
                      return (
                        <motion.a
                          ...
                          variants={textAnime}
                          className='text-[3em] font-Satoshi font-medium relative  cursor-pointer w-fit after:content-[""] after:w-0 after:h-1 after:bg-slate-900 after:absolute after:bottom-0 after:left-0  hover:after:w-full after:transition-all after:duration-300'
                        >
                          {items.name}
                        </motion.a>
                      );
